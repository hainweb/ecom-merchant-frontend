            ...
            <>
              <div className="bg-white rounded-lg shadow p-6">
                ...
                <p className="text-2xl font-bold">
                  ₹{salesMetrics?.deliveredRevenue || 0}
                </p>
              ...
              <div className="bg-white rounded-lg shadow p-6">
                <div className="flex items-center justify-between mb-4">
                  <h3 className="text-gray-500 text-sm">
                    Pending Order Cash From Deliver
                  </h3>
                  <HandCoins className="text-blue-500" size={20} />
                </div>
                <p className="text-2xl font-bold">{pendingCashToAdmin || 0}</p>
                <span className="text-green-500 text-sm">
                  ↑ 8.2% vs last period
                </span>
              </div>
        ...
        <div className="bg-white rounded-lg shadow p-6">
          ...
          <div className="space-y-4">
            <div className="flex justify-between items-center">
              <span>Total Revenue Including Cancelled and Returned Orders</span>
            ...
            <div className="flex justify-between items-center">
              ...
              <span className="font-semibold">{pendingCashToAdmin || 0}</span>
            </div>
          </div>
        </div>
      </main>
